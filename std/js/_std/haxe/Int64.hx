...
private typedef __Int64 = js.lib.BigInt;

@:coreApi
@:transitive
abstract Int64(__Int64) from __Int64 to __Int64 {
	static var view = new js.lib.DataView(new js.lib.ArrayBuffer(8));
	...
	inline function get_high():Int32
		return js.Syntax.code("Number({0})", (this >> new BigInt(32)));

	public var low(get, never):Int32;

	inline function get_low():Int32
		return js.Syntax.code("Number({0})", (BigInt.asIntN(32, this)));
	...
	inline public static function isInt64(val:Dynamic):Bool
		return js.Syntax.typeof(val) == "bigint";

	public static inline function toInt(x:Int64):Int {
		if (x.val < new BigInt(0x80000000) || x.val > new BigInt(0x7FFFFFFF))
			throw "Overflow";
		return js.Syntax.code("Number({0})", x);
	}
	...
	public static inline function ucompare(a:Int64, b:Int64):Int {
		if (a.val < new BigInt(0))
			return (b.val < new BigInt(0)) ? compare(a, b) : 1;
		return (b.val < new BigInt(0)) ? -1 : compare(a, b);
	}
	...
	@:op(A + B) @:commutative private static inline function addInt(a:Int64, b:Int):Int64
		return clamp(a.val + new BigInt(b));
	...
	@:op(A - B) private static inline function intSub(a:Int, b:Int64):Int64
		return clamp(new BigInt(a) - b.val);
	...
	@:op(A << B) public static inline function shl(a:Int64, b:Int):Int64
		return clamp(a.val << new BigInt(b & 63));

	@:op(A >> B) public static inline function shr(a:Int64, b:Int):Int64
		return clamp(a.val >> new BigInt(b & 63));

	@:op(A >>> B) public static inline function ushr(a:Int64, b:Int):Int64
		return BigInt.asIntN(64, BigInt.asUintN(64, a) >> new BigInt(b & 63));
}
