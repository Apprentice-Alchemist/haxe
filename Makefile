...
package_installer_mac: $(INSTALLER_TMP_DIR)/neko-osx.tar.gz package_unix
	...
	cp $(INSTALLER_TMP_DIR)/neko-*/{neko,nekoc,nekoml,nekotools} installer/neko_root/bin
	cp $(INSTALLER_TMP_DIR)/neko-*/libneko.* installer/neko_root/lib
	cp $(INSTALLER_TMP_DIR)/neko-*/*.ndll installer/neko_root/lib/neko 
	cp $(INSTALLER_TMP_DIR)/neko-*/nekoml.std installer/neko_root/lib/neko 
	cp $(INSTALLER_TMP_DIR)/neko-*/include/* installer/neko_root/include 
	...
	cp $(INSTALLER_TMP_DIR)/haxe_*/{haxe,haxelib} intaller/haxe_root/bin
